...
public class DBtabacoLiar extends SQLiteOpenHelper {
    ...
    //Constructor DB
    public DBtabacoLiar (Context context){
        super(context,DATABASE_NAME,null,DATABASE_VERSION);
    }

    public void insertarTabaco (String id, String nombre, String cantidad, String precio){
    ...
    public void datosTabacoLiar(SQLiteDatabase db){
        db.execSQL("INSERT INTO DBtabacoLiar values ('1','Sauvage',30, 5.15)");
        db.execSQL("INSERT INTO DBtabacoLiar values ('2','Pueblo',30 ,5.20)");
        System.out.println("Ha cargado datosTabacoLiar");
